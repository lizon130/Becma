...
@section('title', 'Settings | '.Helper::getSettings('application_name') ?? 'Becma' )
@section('content')
                ...
                <form action="{{ route('admin.setting.update') }}" id="settingForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group  row">
                        ...
                        <div class="col-sm-9" >
                            ...
                            <img src="{{ Helper::getSettings('site_logo') ? asset('uploads/settings/'.Helper::getSettings('site_logo')) : asset('backend/assets/img/no-img.jpg')}}" height="80px" width="100px" class="site_logo_image mt-1 border" alt="">
                        </div>
                    </div>
                    <div class="form-group  row">
                        ...
                        <div class="col-sm-9" >
                            ...
                            <img src="{{ Helper::getSettings('site_favicon') ? asset('uploads/settings/'.Helper::getSettings('site_favicon')) : asset('backend/assets/img/no-img.jpg')}}" height="80px" width="80px" class="site_favicon_image mt-1 border" alt="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="application_phone" value="{{ Helper::getSettings('application_phone') }}" class="form-control" placeholder="Phone" class="form-control" placeholder="Phone" >
                        </div>
                    </div>
