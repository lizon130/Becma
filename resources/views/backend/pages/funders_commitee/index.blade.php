...
@section('content')
    ...
    @include('backend.pages.funders_commitee.modal')
@endsection
@section('script')
    ...
    var table = jQuery('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('commitee.funders.list') }}", // Ensure this route matches your controller
            type: 'GET',
        },
        aLengthMenu: [
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('commitee.funders.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
        ...
        $(document).on('click', '.edit_btn', function(e) {
            ...
            $.ajax({
                url: "{{ route('commitee.funders.edit') }}",
                type: "GET",
                data: {
                    id: id
                },
        ...
        $(document).on('click', '#editBtn', function(e) {
            ...
            if (go_next_step == true) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('commitee.funders.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        url: "{{ route('commitee.funders.delete') }}",
                        data: {
                            id: id
                        },
                        type: "post",
