...
@section('content')
    ...
    @include('backend.pages.gallery_video.modal')
@endsection
@section('script')
    ...
    var table = jQuery('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('gallery.video.list') }}", // Ensure this route matches your controller
            type: 'GET',
        },
        aLengthMenu: [
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('gallery.video.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
        ...
        $(document).on('click', '#editBtn', function(e) {
            ...
            if (go_next_step == true) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('gallery.video.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        url: "{{ route('gallery.video.delete') }}",
                        data: {
                            id: id
                        },
                        type: "post",
