...
@section('title', 'User | Rejected Members')
@section('css')
    <style>
...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Rejected Members</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Rejected Members List</h5>
                        </div>
                    </div>
                </div>
            </div>
...
$(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            $.get("{{ route('users.reject.index') }}" + '/' + user_id + '/edit', function (data) {
                // Check for errors
                if (data.error) {
                    alert(data.error);
                    return;
        ...
        $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('users.reject.store') }}", // Use the appropriate route
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteUser', function () {
                ...
                if(confirm("Are You sure want to delete !")){
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('users.reject.destroy', '') }}" + "/" + user_id,
                        success: function (data) {
                            table.draw();
                        },
                        error: function (data) {
