...
@section('title', 'User | Active Members')
@section('css')
    <style>
...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Active Members</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Active Members List</h5>
                        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.get("{{ route('users.active.index') }}" + '/' + user_id + '/edit', function (data) {
                // Check for errors
                if (data.error) {
                    alert(data.error);
                    return;
            ...
            $.ajax({
                    ...
                    url: "{{ route('users.active.store') }}", // Use the appropriate route
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteUser', function () {
                ...
                if(confirm("Are You sure want to delete !")){
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('users.active.destroy', '') }}" + "/" + user_id,
                        success: function (data) {
                            table.draw();
                        },
                        error: function (data) {
