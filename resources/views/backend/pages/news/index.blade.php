...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2 mb-3">Updated News</h4>
...
@section('script')
    ...
    var table = jQuery('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('news.list') }}", // Ensure this route matches your controller
            type: 'GET',
        },
        aLengthMenu: [
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('news.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
            ...
            console.log(xhr.responseText);  // Log the raw error response for better debugging
