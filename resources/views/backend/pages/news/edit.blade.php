<form id="editForm">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description" required value="{{$news->description }}">{{$news->description }}</textarea>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="profile_image_input--container position-relative">
                    <label class="cover_image" for="edit_cover_image">
                        <img class="preview_cover cursor-pointer" src="{{ $news->image ? asset($news->image) : asset('backend/assets/img/gray-cover.png') }}" alt="">
