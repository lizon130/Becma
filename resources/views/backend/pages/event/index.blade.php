...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2 mb-3">Event Category</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Event Category List</h5>
                        </div>
...
function getList() {
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('event.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                let errorMessage = xhr.responseJSON?.msg || 'Something went wrong!';
                console.log(xhr);  // Log entire response for debugging
                $('#createForm .server_side_error').html(
                    '<div class="alert alert-danger alert-dismissible fade show" role="alert">' +
                    errorMessage +
                    '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>'
