...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2 mb-3">Blog Category</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Blog Category List</h5>
                        </div>
...
@section('script')
    ...
    var table = jQuery('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('blog.list') }}", // Ensure this route matches your controller
            type: 'GET',
        },
        aLengthMenu: [
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('blog.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
