...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2 mb-3">Service Category</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Service Category List</h5>
                        </div>
...
@section('script')
    <script type="text/javascript">
       function getList() {
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('service.list') }}", // Ensure this route matches your controller
            type: 'GET',
        },
        aLengthMenu: [
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('service.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
