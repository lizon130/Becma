<form id="editForm">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description" required value="{{ $service->description }}">{{$service->description }}</textarea>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="profile_image_input--container position-relative">
                    <label class="cover_image" for="edit_cover_image">
                        <img class="preview_cover cursor-pointer" src="{{ $service->image ? asset($service->image) : asset('backend/assets/img/gray-cover.png') }}" alt="">
        ...
        {{-- <div class="form-group row">
            ...
            <div class="col-sm-12">
                ...
                <input type="file" id="edit_cover_image" name="cover_image" class="d-none" onchange="imagePreview('#edit_cover_image', '#editForm .preview_cover')">
            </div>
        </div> --}}
