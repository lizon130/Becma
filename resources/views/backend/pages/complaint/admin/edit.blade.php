<form id="editForm">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description" required value="{{$complaint->description }}">{{$complaint->description }}</textarea>
            </div>
        </div>
        ...
        {{-- <div class="form-group row">
            ...
            <div class="col-sm-12">
                <select name="status" class="form-control" required>
                    ...
                    <option value="published" {{ $complaint->status == 'published' ? 'selected' : '' }}>Published</option>
                    <option value="unpublished" {{ $complaint->status == 'unpublished' ? 'selected' : '' }}>Unpublished</option>
                </select>
            </div>
        </div> --}}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                ...
                <img class="preview_cover mt-2" src="{{ $complaint->image ? asset($complaint->image) : asset('backend/assets/img/gray-cover.png') }}" alt="Preview" style="max-width: 200px; display: none;">
            </div>
        </div>
