...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2 mb-3">Complaint</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Complaints List</h5>
                        </div>
    ...
    @include('backend.pages.complaint.seller.modal')
@endsection
@section('script')
    ...
    var table = jQuery('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('seller.complain.list') }}", // Ensure this route matches your controller
            type: 'GET',
        },
        aLengthMenu: [
    ...
    if (go_next_step == true) {
        ...
        $.ajax({
            ...
            url: "{{ route('seller.complain.store') }}",  // Ensure this route matches
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
        ...
        $(document).on('click', '.edit_btn', function(e) {
            ...
            $.ajax({
                url: "{{ route('seller.complain.edit') }}",
                type: "GET",
                data: {
                    id: id
                },
        ...
        $(document).on('click', '#editBtn', function(e) {
            ...
            if (go_next_step == true) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('seller.complain.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        url: "{{ route('seller.complain.delete') }}",
                        data: {
                            id: id
                        },
                        type: "post",
