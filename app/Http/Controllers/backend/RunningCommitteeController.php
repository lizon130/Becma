...
class RunningCommitteeController extends Controller
{
    public function index(){
        return view('backend.pages.running_commitee.index');
    }

    public function getList(Request $request)
    {
        $data = Executive_commitee::where('committee_category', 'running_committee')
    ...
    public function edit(Request $request)
    {
        ...
        return view('backend.pages.executive_commitee.edit', $data);
    }
