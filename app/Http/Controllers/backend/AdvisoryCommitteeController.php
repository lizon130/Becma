...
class AdvisoryCommitteeController extends Controller
{
    public function index(){
        return view('backend.pages.advisory_commitee.index');
    }

    public function getList(Request $request)
    {
        $data = Executive_commitee::where('committee_category', 'advisory_committee')
    ...
    public function edit(Request $request)
    {
        ...
        return view('backend.pages.advisory_commitee.edit', $data);
    }
