...
class PreviousCommitteeController extends Controller
{
    public function index(){
        return view('backend.pages.previous_commitee.index');
    }

    public function getList(Request $request)
    {
        $data = Executive_commitee::where('committee_category', 'previous_committee')
    ...
    public function edit(Request $request)
    {
        ...
        return view('backend.pages.previous_commitee.edit', $data);
    }
